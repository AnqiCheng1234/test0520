...
DEFAULT_RUN_NAME="0516_vits_vkitti_lod_dn_rgb_bridge_decoder_644x1008_bs8acc1_ssi_lod3_eth3d_best_speedup_e10"
if [[ -n "${VKITTI_CACHE_ROOT}" ]]; then
  DEFAULT_RUN_NAME="0516_vits_vkitti_lod_dn_rgb_bridge_decoder_644x1008_bs8acc1_vkcachek1rand_fp32_ssi_lod3_eth3d_best_speedup_e10"
fi
