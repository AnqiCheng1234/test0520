#!/usr/bin/env bash
set -euo pipefail
export RUN_NAME="${RUN_NAME:-0430_c3_vkitti_lod_dn_bridge_last8_644x1008_bs2acc8_ssi_lod3_eth3d_kitti_rnight_e10}"
export INPUT_TYPE="${INPUT_TYPE:-raw_ram_bridge}"
export DAV2_TRAIN_MODE="${DAV2_TRAIN_MODE:-last:8}"
