...
RUN="0430_c1_vkitti_lod_dn_bridge_full_lrd09_644x1008_bs2acc8_ssi_lod3_eth3d_kitti_rnight_e10"
...
echo "[4/4] KITTI full-frame 2x3 panels"
...
echo "All C1 visual analyses finished."
